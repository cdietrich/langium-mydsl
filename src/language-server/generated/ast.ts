...
export type MydslAstType = 'Greeting' | 'Model' | 'Person';

export type MydslAstReference = 'Greeting:person';

export class MydslAstReflection implements AstReflection {
    ...
    getReferenceType(referenceId: MydslAstReference): string {
        switch (referenceId) {
